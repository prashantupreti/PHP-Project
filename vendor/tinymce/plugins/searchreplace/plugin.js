...
var searchreplace = (function () {
  ...
  var $_8a4jpzjbjglr4v6n = { findAndReplaceDOMText: findAndReplaceDOMText };
  ...
  var markAllMatches = function (editor, currentIndexState, regex) {
    ...
    return $_8a4jpzjbjglr4v6n.findAndReplaceDOMText(regex, node, marker, false, editor.schema);
  };
  ...
  var get = function (editor, currentIndexState) {
    var done = function (keepEditorSelection) {
      return $_1mb4noj9jglr4v67.done(editor, currentIndexState, keepEditorSelection);
    };
    var find = function (text, matchCase, wholeWord) {
      return $_1mb4noj9jglr4v67.find(editor, currentIndexState, text, matchCase, wholeWord);
    };
    var next = function () {
      return $_1mb4noj9jglr4v67.next(editor, currentIndexState);
    };
    var prev = function () {
      return $_1mb4noj9jglr4v67.prev(editor, currentIndexState);
    };
    var replace = function (text, forward, all) {
      return $_1mb4noj9jglr4v67.replace(editor, currentIndexState, text, forward, all);
    };
    return {
      done: done,
      find: find,
  ...
  var open = function (editor, currentIndexState) {
    ...
    function updateButtonStates() {
      win.statusbar.find('#next').disabled($_1mb4noj9jglr4v67.hasNext(editor, currentIndexState) === false);
      win.statusbar.find('#prev').disabled($_1mb4noj9jglr4v67.hasPrev(editor, currentIndexState) === false);
    }
    ...
    var win = editor.windowManager.open({
      ...
      onClose: function () {
        editor.focus();
        $_1mb4noj9jglr4v67.done(editor, currentIndexState);
        editor.undoManager.add();
      },
      onSubmit: function (e) {
        ...
        if (!text.length) {
          $_1mb4noj9jglr4v67.done(editor, currentIndexState, false);
          win.statusbar.items().slice(1).disabled(true);
          return;
        }
        if (last.text === text && last.caseState === caseState && last.wholeWord === wholeWord) {
          if (!$_1mb4noj9jglr4v67.hasNext(editor, currentIndexState)) {
            notFoundAlert();
            return;
          }
          $_1mb4noj9jglr4v67.next(editor, currentIndexState);
          updateButtonStates();
          return;
        }
        count = $_1mb4noj9jglr4v67.find(editor, currentIndexState, text, caseState, wholeWord);
        if (!count) {
          notFoundAlert();
        }
      ...
      buttons: [
        ...
        },
        {
          ...
          disabled: true,
          onclick: function () {
            if (!$_1mb4noj9jglr4v67.replace(editor, currentIndexState, win.find('#replace').value())) {
              win.statusbar.items().slice(1).disabled(true);
              currentIndexState.set(-1);
              last = {};
            }
        ...
        },
        {
          ...
          disabled: true,
          onclick: function () {
            $_1mb4noj9jglr4v67.replace(editor, currentIndexState, win.find('#replace').value(), true, true);
            win.statusbar.items().slice(1).disabled(true);
            last = {};
          }
        },
        ...
        },
        {
          ...
          disabled: true,
          onclick: function () {
            $_1mb4noj9jglr4v67.prev(editor, currentIndexState);
            updateButtonStates();
          }
        },
        {
  ...
  var $_a8wvygjdjglr4v7i = { open: open };

  var register = function (editor, currentIndexState) {
    editor.addCommand('SearchReplace', function () {
      $_a8wvygjdjglr4v7i.open(editor, currentIndexState);
    });
  };
  var $_cau1fajcjglr4v7i = { register: register };
  ...
  var $_54wmlgjejglr4v7i = { register: register$1 };

  global.add('searchreplace', function (editor) {
    var currentIndexState = Cell(-1);
    $_cau1fajcjglr4v7i.register(editor, currentIndexState);
    $_54wmlgjejglr4v7i.register(editor, currentIndexState);
    return $_fjodzrj8jglr4v5r.get(editor, currentIndexState);
  });
  function Plugin () {
  }
