...
var contextmenu = (function () {
  ...
  var $_bzz79sadjglr4t62 = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_7io2h8acjglr4t62.getContextMenu(editor);
  ...
  var $_3pcsj0agjglr4t6i = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_7io2h8acjglr4t62.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_3pcsj0agjglr4t6i.show(editor, $_bzz79sadjglr4t62.getPos(editor, e), visibleState, menu);
    });
  };
  var $_6f4h71abjglr4t62 = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_6f4h71abjglr4t62.setup(editor, visibleState, menu);
    return $_e1vq3caajglr4t62.get(visibleState);
  });
  function Plugin () {
  }
