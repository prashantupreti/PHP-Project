...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_33bcpteojglr4ua0.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_33bcpteojglr4ua0.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_33bcpteojglr4ua0.getSelectorConverter(editor)) {
      selectorConverter = $_33bcpteojglr4ua0.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_33bcpteojglr4ua0.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_33bcpteojglr4ua0.getCssGroups(editor));
      ...
      if (!$_33bcpteojglr4ua0.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_33bcpteojglr4ua0.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_72sr2tejjglr4ua0.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_7o90tmeijglr4u9k = { get: get };

  global.add('importcss', function (editor) {
    $_72sr2tejjglr4ua0.setup(editor);
    return $_7o90tmeijglr4u9k.get(editor);
  });
  function Plugin () {
  }
