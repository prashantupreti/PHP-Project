...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_a8fyjdipjglr4v10.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_a8fyjdipjglr4v10.getPreviewDialogWidth(editor);
    var dialogHeight = $_a8fyjdipjglr4v10.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_9c7txdiqjglr4v1f.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_224hy4injglr4v10 = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_224hy4injglr4v10.open(editor);
    });
  };
  var $_cv201timjglr4v10 = { register: register };
  ...
  var $_4xuyiuisjglr4v1f = { register: register$1 };

  global.add('preview', function (editor) {
    $_cv201timjglr4v10.register(editor);
    $_4xuyiuisjglr4v1f.register(editor);
  });
  function Plugin () {
  }
