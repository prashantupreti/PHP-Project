...
var textpattern = (function () {
  ...
  var $_8nuur3r0jglr4zmn = { getPatterns: getPatterns };
  ...
  var patternFromRng = function (patterns, rng, space) {
    ...
    var endPattern = $_230raer8jglr4zni.findEndPattern(patterns, text, rng.startOffset, delta);
    ...
    var startPattern = $_230raer8jglr4zni.findPattern(patterns, patternRng.toString());
  ...
  var applyBlockFormat = function (editor, patterns) {
    ...
    if (textBlockElm) {
      ...
      if (firstTextNode) {
        pattern = $_230raer8jglr4zni.findPattern(patterns, firstTextNode.data);
        if (!pattern) {
          return;
        }
  ...
  function handleEnter(editor, patterns) {
    ...
    wrappedTextNode = $_646lq1r5jglr4zn3.applyInlineFormatEnter(editor, patterns);
    if (wrappedTextNode) {
    ...
    $_646lq1r5jglr4zn3.applyBlockFormat(editor, patterns);
  }
  function handleInlineKey(editor, patterns) {
    var wrappedTextNode, lastChar, lastCharNode, rng, dom;
    wrappedTextNode = $_646lq1r5jglr4zn3.applyInlineFormatSpace(editor, patterns);
    if (wrappedTextNode) {
      dom = editor.dom;
  ...
  var setup = function (editor, patternsState) {
    ...
    editor.on('keydown', function (e) {
      if (e.keyCode === 13 && !global$2.modifierPressed(e)) {
        $_1v0g9or4jglr4zn3.handleEnter(editor, patternsState.get());
      }
    }, true);
    editor.on('keyup', function (e) {
      if ($_1v0g9or4jglr4zn3.checkKeyCode(keyCodes, e)) {
        $_1v0g9or4jglr4zn3.handleInlineKey(editor, patternsState.get());
      }
    });
    editor.on('keypress', function (e) {
      if ($_1v0g9or4jglr4zn3.checkCharCode(charCodes, e)) {
  ...
  var $_6m7f6yr1jglr4zmn = { setup: setup };

  global.add('textpattern', function (editor) {
    var patternsState = Cell($_8nuur3r0jglr4zmn.getPatterns(editor.settings));
    $_6m7f6yr1jglr4zmn.setup(editor, patternsState);
    return $_e9hklxqzjglr4zmn.get(patternsState);
  });
  function Plugin () {
  }
