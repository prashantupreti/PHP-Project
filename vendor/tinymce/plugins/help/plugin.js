...
var help = (function () {
  ...
  var never$1 = $_ep30l7b1jglr4tau.never;
  var always$1 = $_ep30l7b1jglr4tau.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_ep30l7b1jglr4tau.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var from$1 = $_4xs0htb2jglr4tau.isFunction(Array.from) ? Array.from : function (x) {
    return slice.call(x);
  };
  var $_7pizlpazjglr4tae = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var $_2gs9ngb4jglr4tau = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_7pizlpazjglr4tae.map($_2gs9ngb4jglr4tau.shortcuts, function (shortcut) {
  ...
  var $_anmeezayjglr4t9z = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_cj15ydb9jglr4tc5.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_cj15ydb9jglr4tc5.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_cj15ydb9jglr4tc5.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_cj15ydb9jglr4tc5.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_f2nh3xbajglr4tc5.head(str).bind(function (head) {
      return $_f2nh3xbajglr4tc5.tail(str).map(function (tail) {
  ...
  var $_dtoq8abbjglr4tc5 = { urls: urls };

  var makeLink = $_ep30l7b1jglr4tau.curry($_an1p9jb8jglr4tbp.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_7pizlpazjglr4tae.find($_dtoq8abbjglr4tc5.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_vbxkab7jglr4tbp.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_7pizlpazjglr4tae.filter(keys, $_ep30l7b1jglr4tau.not($_ep30l7b1jglr4tau.curry($_7pizlpazjglr4tae.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_7pizlpazjglr4tae.map(pluginKeys, function (key) {
  ...
  var $_2xm4unb6jglr4tba = { makeTab: makeTab$1 };
  ...
  var $_dtyvgfbcjglr4tck = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_anmeezayjglr4t9z.makeTab(),
          $_2xm4unb6jglr4tba.makeTab(editor)
        ],
        buttons: $_dtyvgfbcjglr4tck.makeRow(),
  ...
  var $_ecnlqaxjglr4t9j = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_ecnlqaxjglr4t9j.open(editor, pluginUrl));
  };
  var $_2m2wjdawjglr4t9j = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_ecnlqaxjglr4t9j.open(editor, pluginUrl)
    });
  ...
  var $_40f44wbejglr4tck = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_40f44wbejglr4tck.register(editor, pluginUrl);
    $_2m2wjdawjglr4t9j.register(editor, pluginUrl);
