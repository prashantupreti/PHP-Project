...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_83smf59yjglr4t0v.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_19x2w9ujglr4szk.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_fehmi19wjglr4szk.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_8rldkm9zjglr4t0v = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_2aayy09tjglr4szk = {
    open: function (editor) {
      var minWidth = $_19x2w9ujglr4szk.getDialogMinWidth(editor);
      var minHeight = $_19x2w9ujglr4szk.getDialogMinHeight(editor);
      var currentLanguage = $_8rldkm9zjglr4t0v.getCurrentLanguage(editor);
      var currentLanguages = $_8rldkm9zjglr4t0v.getLanguages(editor);
      var currentCode = $_fehmi19wjglr4szk.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_fehmi19wjglr4szk.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_83smf59yjglr4t0v.isCodeSample(node)) {
        $_2aayy09tjglr4szk.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_b912lc9sjglr4sz4 = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_83smf59yjglr4t0v.trimArg($_83smf59yjglr4t0v.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_83smf59yjglr4t0v.trimArg($_83smf59yjglr4t0v.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_57fi55a0jglr4t1a = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_19x2w9ujglr4szk.getContentCss(editor);
  ...
  var $_56jwy3a1jglr4t1a = { loadCss: loadCss };
  ...
  var $_b6ywlma2jglr4t1a = { register: register$1 };

  var addedInlineCss = Cell(false);
  global.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_57fi55a0jglr4t1a.setup(editor);
    $_b6ywlma2jglr4t1a.register(editor);
    $_b912lc9sjglr4sz4.register(editor);
    editor.on('init', function () {
      $_56jwy3a1jglr4t1a.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_83smf59yjglr4t0v.isCodeSample(ev.target)) {
        $_2aayy09tjglr4szk.open(editor);
      }
    });
  });
