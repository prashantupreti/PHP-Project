...
var wordcount = (function () {
  ...
  var $_bm74fbsojglr500z = {
    each: each,
    map: map
  };

  var SETS$1 = $_7xtb4zsmjglr500z.SETS;
  var OTHER = $_7xtb4zsmjglr500z.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_bm74fbsojglr500z.map(string.split(''), memoized);
  };
  var $_8ukzgasnjglr500z = { classify: classify };

  var ci = $_7xtb4zsmjglr500z.characterIndices;
  ...
  var $_4c4ebsspjglr501e = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_7xtb4zsmjglr500z.EMPTY_STRING;
  var WHITESPACE$1 = $_7xtb4zsmjglr500z.WHITESPACE;
  var PUNCTUATION$1 = $_7xtb4zsmjglr500z.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_8ukzgasnjglr500z.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_4c4ebsspjglr501e.isWordBoundary(map, i)) {
  ...
  var $_4pkfxgsljglr500z = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_4pkfxgsljglr500z.getWords(getTextContent(editor)).length;
  };
  var $_5mrcguskjglr500j = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_5mrcguskjglr500j.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_egjejgsjjglr500j = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_5mrcguskjglr500j.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_gclqousqjglr501e = { setup: setup };

  global.add('wordcount', function (editor) {
    $_gclqousqjglr501e.setup(editor);
    return $_egjejgsjjglr500j.get(editor);
  });
  function Plugin () {
  }
