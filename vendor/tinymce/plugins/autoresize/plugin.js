...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_a5ha8u8njglr4spk.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_a5ha8u8njglr4spk.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_a5ha8u8njglr4spk.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_a5ha8u8njglr4spk.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_a5ha8u8njglr4spk.getAutoResizeBottomMargin(editor);
    ...
    if ($_a5ha8u8njglr4spk.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_2zd9048kjglr4sp5.resize(editor, oldSize);
    });
  };
  var $_5m6c538jjglr4sop = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_5m6c538jjglr4sop.register(editor, oldSize);
      $_2zd9048kjglr4sp5.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
