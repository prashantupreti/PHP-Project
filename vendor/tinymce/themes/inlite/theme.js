...
var inlite = (function () {
  ...
  var $_b3dti3171jglr580w = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_cfrzik175jglr581c.fromClientRect(clientRect)) : null;
  };
  var $_5yww8j174jglr581c = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_ephii7173jglr581c.result(predicateIds[i].id, $_5yww8j174jglr581c.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_ephii7173jglr581c.result(predicateIds[x].id, $_5yww8j174jglr581c.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_ephii7173jglr581c.result(id, $_5yww8j174jglr581c.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_ephii7173jglr581c.result(id, $_5yww8j174jglr581c.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_7zvj1u17ejglr581r.isArray(value)) {
      return value;
    } else if ($_7zvj1u17ejglr581r.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_7zvj1u17ejglr581r.isBoolean(value)) {
  ...
  var $_epz3tt17djglr581r = {
    getStringOr: getByTypeOr($_7zvj1u17ejglr581r.isString),
    getBoolOr: getByTypeOr($_7zvj1u17ejglr581r.isBoolean),
    getNumberOr: getByTypeOr($_7zvj1u17ejglr581r.isNumber),
    getHandlerOr: getByTypeOr($_7zvj1u17ejglr581r.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_7zvj1u17ejglr581r.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_cfrzik175jglr581c.toClientRect(targetRect),
        contentAreaRect: $_cfrzik175jglr581c.toClientRect(contentAreaRect),
        panelRect: $_cfrzik175jglr581c.toClientRect(panelRect)
      });
      return $_cfrzik175jglr581c.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_epz3tt17djglr581r.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_epz3tt17djglr581r.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_epz3tt17djglr581r.getHandlerOr(editor, 'inline_toolbar_position_handler', $_fg5u8p17fjglr581r.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_2dz1ia17ajglr581r.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_bcnjof17bjglr581r.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_bcnjof17bjglr581r.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_59h3rb179jglr581c = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_b3dti3171jglr580w.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_2k1fye176jglr581c.fromContextToolbars(toolbars);
    result = $_ephii7173jglr581c.match(editor, [
      $_3d3w6f172jglr580w.element(elements[0], contextToolbarsPredicateIds),
      $_3qsucq178jglr581c.textSelection('text'),
      $_3qsucq178jglr581c.emptyTextBlock(elements, 'insert'),
      $_3d3w6f172jglr580w.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_ephii7173jglr581c.match(editor, [$_3qsucq178jglr581c.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_59h3rb179jglr581c.load(editor, function () {
  ...
  var $_4qgagk16xjglr580w = { renderUI: renderUI };
  ...
  var never$1 = $_cimm1t17kjglr582m.never;
  var always$1 = $_cimm1t17kjglr582m.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_cimm1t17kjglr582m.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var from$1 = $_9vtb9w17ljglr5832.isFunction(Array.from) ? Array.from : function (x) {
    return slice.call(x);
  };
  var $_4ka04w17ijglr582m = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_5a3dpc17sjglr583x.parseBox(settings.border);
      self.paddingBox = $_5a3dpc17sjglr583x.parseBox(settings.padding);
      self.marginBox = $_5a3dpc17sjglr583x.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_boxhj4180jglr584t.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_5a3dpc17sjglr583x.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_5a3dpc17sjglr583x.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_5a3dpc17sjglr583x.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_damwuk17zjglr584t.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_boxhj4180jglr584t.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_boxhj4180jglr584t.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_xh6z6181jglr5858 = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_boxhj4180jglr584t.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_boxhj4180jglr584t.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_4ka04w17ijglr582m.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_4ka04w17ijglr582m.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_5a3dpc17sjglr583x.parseBox(self.settings.border);
          ...
          self.borderBox = $_5a3dpc17sjglr583x.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_4qgagk16xjglr580w.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_agi89u16wjglr580g = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_ec7bdt18kjglr587u.resolve(name, scope);
  };
  ...
  var $_b5066n18jjglr587u = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_b5066n18jjglr587u.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_3358a618hjglr587e = { blobToBase64: blobToBase64 };
  ...
  var $_8tj41t18njglr588a = { pickFile: pickFile };
  ...
  var $_5jt6e718pjglr588p = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_69brc618rjglr588p.create(dom, selection.getRng());
    global$4.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_69brc618rjglr588p.resolve(dom, bookmark));
  };
  ...
  var $_4vhlb818qjglr588p = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_5jt6e718pjglr588p.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_4vhlb818qjglr588p.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_dw8fhl18ojglr588a.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_8tj41t18njglr588a.pickFile().then(function (files) {
          var blob = files[0];
          $_3358a618hjglr587e.blobToBase64(blob).then(function (base64) {
            $_dw8fhl18ojglr588a.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_dw8fhl18ojglr588a.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_3gk61i18gjglr587e = { addToEditor: addToEditor };
  ...
  var $_9kph3z18vjglr5895 = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_19ba2n18xjglr5895.isAbsolute(href) && $_19ba2n18xjglr5895.isDomainLike(href) ? askAboutPrefix(editor, href) : global$13.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_dw8fhl18ojglr588a.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_dw8fhl18ojglr588a.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_21rmuj18wjglr5895 = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_7zvj1u17ejglr581r.isArray(items)) {
      return items;
    } else if ($_7zvj1u17ejglr581r.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    global$4.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_7zvj1u17ejglr581r.isFunction(button)) {
            button = button();
          }
  ...
  var $_u5cl218yjglr589k = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return global$4.map(toolbars, function (toolbar) {
        return $_u5cl218yjglr589k.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_u5cl218yjglr589k.create(editor, 'text', $_bcnjof17bjglr581r.getTextSelectionToolbarItems(editor)),
        $_u5cl218yjglr589k.create(editor, 'insert', $_bcnjof17bjglr581r.getInsertToolbarItems(editor)),
        $_21rmuj18wjglr5895.createQuickLinkForm(editor, hide)
      ]);
      return global$11.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_bcnjof17bjglr581r.getPositionHandler(editor);
      contentAreaRect = $_5yww8j174jglr581c.getContentAreaRect(editor);
      panelRect = global$2.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_fg5u8p17fjglr581r.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_fg5u8p17fjglr581r.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_9kph3z18vjglr5895.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_fg5u8p17fjglr581r.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_5yww8j174jglr581c.getContentAreaRect(editor);
        panelRect = global$2.DOM.getRect(panel.getEl());
        result = $_fg5u8p17fjglr581r.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_fg5u8p17fjglr581r.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_2dz1ia17ajglr581r.fireBeforeRenderUI(editor);
  ...
  var $_70a1vu19ljglr58cm = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_cimm1t17kjglr582m.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_fl8sec19mjglr58cm = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_ar1uyy19qjglr58dx = { cached: cached };

  var $_2ok34s19sjglr58ec = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_2ok34s19sjglr58ec.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$2($_2ok34s19sjglr58ec.ELEMENT);
  var isText = isType$2($_2ok34s19sjglr58ec.TEXT);
  var isDocument = isType$2($_2ok34s19sjglr58ec.DOCUMENT);
  var $_g5yby019rjglr58dx = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_g5yby019rjglr58dx.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_ar1uyy19qjglr58dx.cached(function () {
    return getBody($_fl8sec19mjglr58cm.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_fl8sec19mjglr58cm.fromDom(body);
  };
  var $_6ngp5719pjglr58dx = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_4ka04w17ijglr582m.each(fields, function (name, i) {
        struct[name] = $_cimm1t17kjglr582m.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_9vtb9w17ljglr5832.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_4ka04w17ijglr582m.each(array, function (a) {
      if (!$_9vtb9w17ljglr5832.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_4ka04w17ijglr582m.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_cmwbih19yjglr58fn.validateStrArr('required', required);
    $_cmwbih19yjglr58fn.validateStrArr('optional', optional);
    $_cmwbih19yjglr58fn.checkDupes(everything);
    return function (obj) {
      var keys = $_c4j3kr19xjglr58fn.keys(obj);
      var allReqd = $_4ka04w17ijglr582m.forall(required, function (req) {
        return $_4ka04w17ijglr582m.contains(keys, req);
      });
      if (!allReqd)
        $_cmwbih19yjglr58fn.reqMessage(required, keys);
      var unsupported = $_4ka04w17ijglr582m.filter(keys, function (key) {
        return !$_4ka04w17ijglr582m.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_cmwbih19yjglr58fn.unsuppMessage(unsupported);
      var r = {};
      $_4ka04w17ijglr582m.each(required, function (req) {
        r[req] = $_cimm1t17kjglr582m.constant(obj[req]);
      });
      $_4ka04w17ijglr582m.each(optional, function (opt) {
        r[opt] = $_cimm1t17kjglr582m.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_8zzyug19ujglr58f8 = {
    immutable: Immutable,
  ...
  var $_e5me0k19zjglr58fn = { toArray: toArray };

  var node = function () {
    var f = $_b5066n18jjglr587u.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_ubdnw1a5jglr58he.unknown()
    });
  };
  ...
  var $_bjigcl1a4jglr58gy = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_cimm1t17kjglr582m.constant(edge),
    chrome: $_cimm1t17kjglr582m.constant(chrome),
    ie: $_cimm1t17kjglr582m.constant(ie),
    opera: $_cimm1t17kjglr582m.constant(opera),
    firefox: $_cimm1t17kjglr582m.constant(firefox),
    safari: $_cimm1t17kjglr582m.constant(safari)
  };
  ...
  var $_bmchz1a6jglr58he = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_cimm1t17kjglr582m.constant(windows$1),
    ios: $_cimm1t17kjglr582m.constant(ios),
    android: $_cimm1t17kjglr582m.constant(android),
    linux: $_cimm1t17kjglr582m.constant(linux),
    osx: $_cimm1t17kjglr582m.constant(osx),
    solaris: $_cimm1t17kjglr582m.constant(solaris),
    freebsd: $_cimm1t17kjglr582m.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_cimm1t17kjglr582m.constant(isiPad),
      isiPhone: $_cimm1t17kjglr582m.constant(isiPhone),
      isTablet: $_cimm1t17kjglr582m.constant(isTablet),
      isPhone: $_cimm1t17kjglr582m.constant(isPhone),
      isTouch: $_cimm1t17kjglr582m.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_cimm1t17kjglr582m.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_4ka04w17ijglr582m.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_ubdnw1a5jglr58he.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_ubdnw1a5jglr58he.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_td83q1abjglr58ip.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_td83q1abjglr58ip.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_td83q1abjglr58ip.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_td83q1abjglr58ip.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_50szp81acjglr58j4.head(str).bind(function (head) {
      return $_50szp81acjglr58j4.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_c7bcff1aajglr58ip.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_c7bcff1aajglr58ip.contains(uastring, 'edge/') && $_c7bcff1aajglr58ip.contains(uastring, 'chrome') && $_c7bcff1aajglr58ip.contains(uastring, 'safari') && $_c7bcff1aajglr58ip.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_c7bcff1aajglr58ip.contains(uastring, 'chrome') && !$_c7bcff1aajglr58ip.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_c7bcff1aajglr58ip.contains(uastring, 'msie') || $_c7bcff1aajglr58ip.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_c7bcff1aajglr58ip.contains(uastring, 'safari') || $_c7bcff1aajglr58ip.contains(uastring, 'mobile/')) && $_c7bcff1aajglr58ip.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_c7bcff1aajglr58ip.contains(uastring, 'iphone') || $_c7bcff1aajglr58ip.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_9jagmw1a9jglr58i9 = {
    browsers: $_cimm1t17kjglr582m.constant(browsers),
    oses: $_cimm1t17kjglr582m.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_9jagmw1a9jglr58i9.browsers();
    var oses = $_9jagmw1a9jglr58i9.oses();
    var browser = $_vsp51a8jglr58ht.detectBrowser(browsers, userAgent).fold($_bjigcl1a4jglr58gy.unknown, $_bjigcl1a4jglr58gy.nu);
    var os = $_vsp51a8jglr58ht.detectOs(oses, userAgent).fold($_bmchz1a6jglr58he.unknown, $_bmchz1a6jglr58he.nu);
  ...
  var $_9xn02w1a3jglr58gy = { detect: detect$2 };

  var detect$3 = $_ar1uyy19qjglr58dx.cached(function () {
    var userAgent = navigator.userAgent;
    return $_9xn02w1a3jglr58gy.detect(userAgent);
  });
  var $_axjswt1a2jglr58gy = { detect: detect$3 };

  var ELEMENT = $_2ok34s19sjglr58ec.ELEMENT;
  var DOCUMENT = $_2ok34s19sjglr58ec.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_4ka04w17ijglr582m.map(base.querySelectorAll(selector), $_fl8sec19mjglr58cm.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_fl8sec19mjglr58cm.fromDom);
  };
  var $_b5e7id1adjglr58j4 = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_4ka04w17ijglr582m.exists(elements, $_cimm1t17kjglr582m.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_7bzcdt1a1jglr58gj.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_axjswt1a2jglr58gy.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_98ty4i1a0jglr58g3 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_b5e7id1adjglr58j4.is
  };

  var owner = function (element) {
    return $_fl8sec19mjglr58cm.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_fl8sec19mjglr58cm.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_fl8sec19mjglr58cm.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_fl8sec19mjglr58cm.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_4ka04w17ijglr582m.findIndex(kin, function (elem) {
        return $_98ty4i1a0jglr58g3.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_9vtb9w17ljglr5832.isFunction(isRoot) ? isRoot : $_cimm1t17kjglr582m.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_fl8sec19mjglr58cm.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_4ka04w17ijglr582m.filter(elements, function (x) {
        return !$_98ty4i1a0jglr58g3.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_fl8sec19mjglr58cm.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_fl8sec19mjglr58cm.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_fl8sec19mjglr58cm.fromDom);
  };
  var prevSiblings = function (element) {
    return $_4ka04w17ijglr582m.reverse($_e5me0k19zjglr58fn.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_e5me0k19zjglr58fn.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_4ka04w17ijglr582m.map(dom.childNodes, $_fl8sec19mjglr58cm.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_fl8sec19mjglr58cm.fromDom);
  };
  ...
  var spot = $_8zzyug19ujglr58f8.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_5ab0lr19tjglr58ec = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_6ngp5719pjglr58dx.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_4ka04w17ijglr582m.filter($_5ab0lr19tjglr58ec.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_4ka04w17ijglr582m.filter($_5ab0lr19tjglr58ec.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_4ka04w17ijglr582m.filter($_5ab0lr19tjglr58ec.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_4ka04w17ijglr582m.each($_5ab0lr19tjglr58ec.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_b5e7id1adjglr58j4.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_a6ovap19ojglr58dh.ancestors(scope, function (e) {
      return $_b5e7id1adjglr58j4.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_a6ovap19ojglr58dh.siblings(scope, function (e) {
      return $_b5e7id1adjglr58j4.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_a6ovap19ojglr58dh.children(scope, function (e) {
      return $_b5e7id1adjglr58j4.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_b5e7id1adjglr58j4.all(selector, scope);
  };
  var $_clm7pt19njglr58dh = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_4ka04w17ijglr582m.map($_clm7pt19njglr58dh.descendants($_fl8sec19mjglr58cm.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_70a1vu19ljglr58cm.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$4('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_cimm1t17kjglr582m.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_4ka04w17ijglr582m.map($_4ka04w17ijglr582m.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_4ka04w17ijglr582m.map($_4ka04w17ijglr582m.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_4ka04w17ijglr582m.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_6uorx919kjglr58c6 = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_cimm1t17kjglr582m.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_4ka04w17ijglr582m.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_4ka04w17ijglr582m.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_4ka04w17ijglr582m.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_4ka04w17ijglr582m.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_4ka04w17ijglr582m.indexOf(items, url).isNone()) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_6uorx919kjglr58c6.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_9vtb9w17ljglr5832.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_6ngp5719pjglr58dx.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_fl8sec19mjglr58cm.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_fl8sec19mjglr58cm.fromDom(element.parentNode), function (x) {
      return !$_98ty4i1a0jglr58g3.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_4ka04w17ijglr582m.find(scope.dom().childNodes, $_cimm1t17kjglr582m.compose(predicate, $_fl8sec19mjglr58cm.fromDom));
    return result.map($_fl8sec19mjglr58cm.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_fl8sec19mjglr58cm.fromDom(element.childNodes[i])))
          return Option.some($_fl8sec19mjglr58cm.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_b5e7id1adjglr58j4.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_8z8zy81ajjglr58kf.ancestor(scope, function (e) {
      return $_b5e7id1adjglr58j4.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_8z8zy81ajjglr58kf.sibling(scope, function (e) {
      return $_b5e7id1adjglr58j4.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_8z8zy81ajjglr58kf.child(scope, function (e) {
      return $_b5e7id1adjglr58j4.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_b5e7id1adjglr58j4.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_b5e7id1adjglr58j4.is, ancestor$1, scope, selector, isRoot);
  };
  var $_1g6f5w1aijglr58k0 = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_50cl3a1amjglr58lq.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_50cl3a1amjglr58lq.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_50cl3a1amjglr58lq.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_50cl3a1amjglr58lq.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    global$4.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_50cl3a1amjglr58lq.postRenderFormat(editor, name)
      });
    });
  };
  var $_9fxtvn1aljglr58lq = { register: register };
  ...
  var $_169l3g1anjglr58lq = { register: register$1 };
  ...
  var $_bv86b71aojglr58lq = { register: register$2 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_50cl3a1amjglr58lq.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_7wulxs1apjglr58lq = { register: register$3 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_50cl3a1amjglr58lq.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return global$4.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_50cl3a1amjglr58lq.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_fbuwzs1aqjglr58m6 = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_4ka04w17ijglr582m.flatten(global$4.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_4ka04w17ijglr582m.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_4ka04w17ijglr582m.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_estlvx1arjglr58m6 = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    global$4.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_50cl3a1amjglr58lq.postRenderFormat(editor, name),
        onclick: $_50cl3a1amjglr58lq.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_50cl3a1amjglr58lq.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_at7wlu1asjglr58ml = { register: register$6 };
  ...
  var $_30nfbk1atjglr58ml = { register: register$7 };
  ...
  var $_d86mu91aujglr58ml = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$1.container = $_1g6f5w1aijglr58k0.descendant($_fl8sec19mjglr58cm.fromDom(document.body), editor.settings.ui_container).fold($_cimm1t17kjglr582m.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_fbuwzs1aqjglr58m6.register(editor);
    $_9fxtvn1aljglr58lq.register(editor);
    $_at7wlu1asjglr58ml.register(editor);
    $_30nfbk1atjglr58ml.register(editor);
    $_bv86b71aojglr58lq.register(editor);
    $_169l3g1anjglr58lq.register(editor);
    $_7wulxs1apjglr58lq.register(editor);
    $_d86mu91aujglr58ml.register(editor);
    $_estlvx1arjglr58m6.register(editor);
  };
  var $_3wxdt01ahjglr58jk = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_9vtb9w17ljglr5832.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_9vtb9w17ljglr5832.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_damwuk17zjglr584t,
      Control: Control$1,
      Factory: global$11,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_fbwmkr18djglr586z,
      Panel: Panel,
      Movable: $_xh6z6181jglr5858,
      Resizable: $_g0k7rk18ejglr586z,
      ...
      FormatControls: $_3wxdt01ahjglr58jk,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_3wxdt01ahjglr58jk.setup(editor);
    $_3gk61i18gjglr587e.addToEditor(editor, panel);
    return $_agi89u16wjglr580g.get(editor, panel);
  });
  function Theme () {
  }
